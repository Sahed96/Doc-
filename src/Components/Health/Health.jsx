...
const Health = () => {
  return (
    <div className="bg-[#FFFFF5] rounded-[32px] p-10 mt-[160px] min-h-[928px]">
      <div className="grid grid-cols-2 gap-8">
        ...
        <div className="relative">
          ...
          <div className="absolute text-white opacity-60 p-7 left-5 bottom-[70px] bg-[#020043] rounded-[32px] min-w-[321px] min-h-[144px] ">
        ...
        <div className="relative">
          ...
          <div className="absolute text-white opacity-60 p-7 left-5 bottom-5 bg-[#020043] rounded-[32px] min-w-[321px] min-h-[144px] ">
